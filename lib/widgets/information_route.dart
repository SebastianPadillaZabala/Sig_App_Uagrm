...
class _InfoRouteBody extends StatelessWidget {
  ...
  final String path = replaceSpacesWithPlus(mapBloc.state.pointsCar!.endPlace);
  showModalBottomSheet(
    context: context,
    isScrollControlled: true, // Mostrar el modal en el centro
    builder: (BuildContext ctx) {
      return Container(
        height: MediaQuery.of(context).size.height, // Ocupar toda la altura de la pantalla
        child: Center(
          child: Image.network(
            'https://sig2023.s3.amazonaws.com/$path.jpg',
            fit: BoxFit.contain,
          ),
        ),
      );
            ...
            children: [
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  backgroundColor: const Color.fromRGBO(42, 57, 100, 1),
                  onPressed: () {
